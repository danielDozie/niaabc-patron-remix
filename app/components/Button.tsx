  ...
  return (
    <>
      {type === "flat-gradient" ? (
        ...
        <button className="w-full md:w-auto md:ml-auto mt-4 md:mt-0 bg-pink-900 bg-gradient-to-r from-pink-900 to-red-900  text-white font-semibold py-2 px-4 rounded-full || hover:bg-gradient-to-l hover:from-pink-900 hover:to-red-900 ">
          <p className="mt-1">{text}</p> <span>{icon}</span>
        </button>
      ) : type === "rounded" ? (
